      ...
      <nav className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link
              href={routes.HOME}
              className="text-xl font-bold bg-gradient-to-r from-accent-light to-primary-300 bg-clip-text text-transparent hover:from-accent hover:to-primary-400 transition-all"
              data-testid="site-logo"
            >
              {t('common.siteTitle', 'Movie Database')}
            </Link>
          </div>
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link
              href={routes.WATCHLIST}
              className="flex items-center gap-2 px-3 py-2 rounded-md text-base text-gray-100 hover:text-white hover:bg-secondary-700"
