    ...
    >
      <div className="relative w-full h-full">
        <Link href={`/${lng}/movie/${movie.id}`}>
          ...
          <div className={CARD_STYLES.content}>
            <h3 className="text-sm font-medium line-clamp-2 text-gray-900 dark:text-white min-h-[2.5rem]">
              {movie.title}
            </h3>
        ...
        <Popover className="absolute top-2 right-2 z-10">
          <Popover.Button className="p-1 rounded-full bg-black/50 text-white opacity-0 group-hover:opacity-100 transition-opacity hover:bg-black/70 focus:outline-none focus:ring-2 focus:ring-white/20">
            <svg
